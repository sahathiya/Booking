...
// import React, { useState } from "react";
// import axiosInstance from "../../Axios/axiosinstance"; // Assuming you have an axios instance for API calls
...
//     alert("Image saved successfully!");
//     setShowModal(false);
//     // Here, you would upload the image to the server, e.g., using a POST request to save the image
//   };

//   const handleRemove = async () => {
//     try {
//       // Assuming the backend endpoint is `/remove-profile-image`
//       const response = await axiosInstance.delete('/remove-profile-image', {
//         data: { imageUrl: previewImage }
//       });
//       // Assuming the response contains success information
//       if (response.data.success) {
//         setPreviewImage("/default-avatar.png"); // Reset to default avatar
