...
function TroubleP() {
  ...
  <h1 className="text-2xl font-bold text-gray-900 mb-4">Having trouble signing in?</h1>
  ...
  <div className="flex items-center justify-between mb-4">
    ...
    <Link to="/forgot-password"><i className="fas fa-chevron-right text-gray-400"></i></Link>
  </div>
  ...
  <Link  to="/contact-support"><i className="fas fa-chevron-right text-gray-400"></i></Link>  
  </div>
  <hr className="border-gray-300" />
  ...
  <div className="flex items-center justify-between mt-4">
   ...
   <Link to="/loginemail">  <i className="fas fa-chevron-right text-gray-400"></i></Link>
  </div>
